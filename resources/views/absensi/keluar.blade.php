...
// Tambahkan pengecekan null pada $user
$defaultAvatar = $user 
...
<div class="relative -mt-7 max-w-[380px] mx-auto p-4 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-lg border border-gray-200 text-center">
    ...
    <h1 class="text-xl font-semibold">Absen Pulang</h1>
...
<form id="absenForm" action="{{ route('absenkeluar.absenKeluar') }}" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="p-4">
    ...
    <textarea name="desc" id="desc" rows="4" class="w-full p-2.5 text-sm bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Keterangan tambahan jika ada..."></textarea>
</div>
...
function enableSubmitCheck() {
    ...
    console.log('🔍 ENABLE SUBMIT CHECK:', { lokasiOk, fotoOk, descOk, allOk });
    ...
    if (allOk) {
        ...
        submitBtn.innerHTML = 'Absen Pulang';
...
document.getElementById('absenForm').addEventListener('submit', function(e) {
    ...
    submitStatusMessage.style.color = '#047857';
});
...
//  Inisialisasi
// ==============================
console.log('📱 Halaman Absen Pulang dimuat');
setTimeout(() => {
    enableSubmitCheck();
    if (!faceapiLoaded && !faceapiLoading && !faceapiFallback) {
        loadFaceAPI();
